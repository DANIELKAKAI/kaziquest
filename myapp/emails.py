...
def send_verify_code(user_email):
	...
	msg = "Click the following link to verify email:\n http://http://68.183.34.33:8080/verify-email/?code={}".format(code)
	send_mail('Confirm email', msg, 'Confirm Email  <devemail359@gmail.com>', [user_email], fail_silently=True)
